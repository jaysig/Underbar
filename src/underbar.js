(function() {
  ...
  _.last = function(array, n) {
    return n === undefined ? array[array.length-1] : n > array.length ? array.slice(0, n) :array.slice(array.length - n);
  };
  ...
  _.extend = function(obj) {
    ...
    //pass arguements
    //return object
    _.each(arguments,function(arguObj){
      _.each(arguObj,function(value,key){
        obj[key] = value;
      });
    });
    return obj;
